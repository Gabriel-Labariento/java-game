...
public class FishMonster extends Enemy{
    ...
    private static final int limpCDDuration = 50;
    ...
    public void updateEntity(ServerMaster gsm){
        ...
        switch (currentForm) {
            case PHASE1:
                ...
                if (now - lastLimpTime > limpCDDuration){
            ...
            case PHASE3:
                ...
                if (now - lastAttackTime > attackCDDuration && distanceSquared <= actionDistance){
                    ...
                    else createBulletCircle(gsm, pursued);
                }
    ...
    private void createBulletCircle(ServerMaster gsm, Player target){
