...
public class FishMonster extends Enemy{
    ...
    public FishMonster(int x, int y) {
     ...
     private static void setSprites() {
        try {
            BufferedImage left0 = ImageIO.read(FishMonster.class.getResourceAsStream("resources/Sprites/FishMonster/left0.png"));
            BufferedImage right0 = ImageIO.read(FishMonster.class.getResourceAsStream("resources/Sprites/FishMonster/right0.png"));
